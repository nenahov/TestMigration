...
public class Settings extends JPanel {
	...
	public Settings() {
		...
		panel.setBorder(new TitledBorder(null, "—имволом-разделителем €вл€етс€:", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
		panel.setLayout(new GridLayout(0, 2));
		add(panel, BorderLayout.NORTH);

		cbTz = new JCheckBox();
		buttonGroup.add(cbTz);
		cbTz.setText("точка с зап€той");
		panel.add(cbTz);
